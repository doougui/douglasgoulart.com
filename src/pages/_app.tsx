  ...
  return (
    <ThemeProvider theme={theme}>
      <Head>
        ...
        <meta
          name="description"
          content="Full-stack software engineer based in Brazil and focused on web solutions"
        />
      ...
      <DefaultSeo
        openGraph={{
          ...
          locale: 'en_US',
          description:
            'Full-stack software engineer based in Brazil and focused on web solutions',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: 'Full-stack software engineer with an eye for design.',
              type: 'image/jpeg',
            },
          ],
