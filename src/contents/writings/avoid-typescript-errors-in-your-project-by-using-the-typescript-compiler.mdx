...
![Typecheck command with no errors](/img/contents/writings/typecheck-no-errors.png)

If some error(s) was found, you should see something like this:

![Typecheck command with errors](/img/contents/writings/typecheck-with-errors.png)
...
![Executing task](/img/contents/writings/executing-task.png)

![Executing task](/img/contents/writings/test.png)
