...
- https://www.typescriptlang.org/docs/handbook/compiler-options.html it out yourself and feel the difference, to help you I created a vite-react-tailwind starter template, you can [check it out on my github.](https://github.com/theodorusclarence/vite-react-tailwind-starter) Now, open up your terminal and run this code
